...
import { Users, MessageCircle, Lightbulb, Zap, Rocket } from "lucide-react";
    ...
    <section className="py-16 md:py-24 bg-[#000942] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Entre na comunidade do AcademIA Business para receber{" "}
            <strong className="text-white">conteúdos exclusivos, provocações e aprendizados</strong>{" "}
            que acontecem por dentro do programa.
          </motion.p>
