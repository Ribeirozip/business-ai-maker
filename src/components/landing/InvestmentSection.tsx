...
const InvestmentSection = () => {
  return (
    <section id="investimento" className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
            Leve a Inteligência Artificial para dentro da sua organização com um programa 100% adaptado.
          </p>
        </motion.div>
